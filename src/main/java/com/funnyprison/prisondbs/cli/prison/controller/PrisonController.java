...
import static com.funnyprison.prisondbs.cli.prison.domain.SearchCondition.*;
...
public class PrisonController {
    ...
    private void showSearchPrisonerData() {
        ...
        // 핵심 로직
        List<Prison> prisonerList = prisonerRepository.searchPrisonerList(keyword, condition);
    ...
    private void insertPrisonerData() {
        ...
        // 저장 명령
        prisonerRepository.addPrisoner(newPrison);
